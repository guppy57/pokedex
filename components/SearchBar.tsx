export default function SearchBar(): JSX.Element {
  ...
  // create a function to control query submit a user clicks the "enter key"
  ...
  return (
    <form className="mt-4 lg:max-w-screen-md md:max-w-screen-sm sm:mx-auto sm:flex max-w-screen-md">
      ...
      <div className="mt-4 sm:mt-0 sm:ml-3">
        <button className="block w-full rounded-md border border-transparent bg-red-600 px-5 py-3 text-base font-medium text-white hover:bg-red-400 sm:px-10 shadow-2xl">
          Search
        </button>
      </div>
    </form>
